---
title: <center><font size="6"><b>Creating mixed groups</b></font></center>
...
- <font size="6"><b>`r if(any(duplicated(df$ID))) ("Warning: at least 1 ID is duplicated")`</b></font>
...
df_col$Color <- gsub("mez", "DOS COLORES ", df_col$Color)
...
```{r Number of individuals by mixed group, eval = TRUE}
...
- `r sprintf("Algoritmo de busqueda fue corrido por %1.0f iteraciones", replications)`

- `r if (any(df_col$Comentarios == "Debe ser coloreado")) "Al menos un individuo sin color debe ser pintado cuando se creen los grupos mixtos"`

- `r if (any(df_col$Grupo_mixto == "No asignado")) sprintf("Hay %1.0f individuo(s) que no fue(ron) asignado(s) a ningun grupo mixto", sum(df_col$Grupo_mixto == "No asignado")) else ("Todos los individuos fueron usados en los grupos mixtos")`


<b><p style="font-family:Courier; color:Red; font-size: 30px;">`r if(any(duplicated(df_col[df_col$Color != "Sin pintar", c("Color", "Grupo_mixto")]))) ("Warning: al menos un color duplicado en un grupo mixto")`</p></b>