...
unpaired_csvs <- list.files(path = "/home/m/Dropbox/Salidas de videos analizados/Salidas50FramesXBicho/", pattern ="unpaired", recursive = TRUE, full.names = TRUE)
...
## add frame labels
frame_labels <- read.csv("/home/m/Dropbox/Salidas de videos analizados/Salidas50FramesXBicho/framesXToma50Puntos.csv")
...
table(unpaired_df$file)


video <- sapply(unpaired_df$file, function(x) strsplit(x, "_")[[1]][1])

unpaired_df$video <- as.numeric(gsub("T", "", video))
