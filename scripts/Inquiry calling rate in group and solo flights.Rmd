---
title: <font size="6"><b>Inquiry calling rate in group and solo flights</b></font>
subtitle: <font size="4"><b>Group flight coordination in Thyroptera</b></font>
author: <font size="4"><a href="http://marceloarayasalas.weebly.com/">Marcelo Araya-Salas, PhD</a> & <a href="https://www.batcr.com/">Gloriana Chaverri, PhD</a></font>
date: "`r Sys.Date()`"
output:
  html_document:
    code_folding: hide
...
```{r measure coordination, eval = FALSE}
...
```{r measure coordination 2, eval = FALSE}
